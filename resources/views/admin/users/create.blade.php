    ...
    <div class="container mt-5">
        <div class="card shadow-lg p-4">
             <h2 class="mb-4"
                ...
                <span class="badge bg-success" style="font-size: 1.3rem;">Ajouter un utilisateur </span>
            </h2>
                    ...
                    <ul class="mb-0">
                        @foreach ($errors->all() as $error)
                            <li>{{ str_replace(
                                ...
                                ['Cet email existe déjà, veuillez en saisir un autre.', ' Ce matricule existe déjà, veuillez en saisir un autre.'],
                                $error,
                            ) }}
                            </li>
                        @endforeach
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-success btn-lg w-25">Créer</button>
                </div>
            </form>
        </div>
    </div>
